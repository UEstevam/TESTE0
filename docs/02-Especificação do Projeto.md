...
|--------------------------------------------------|---------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Pedro  Martins    | Preciso de um sistema que me permita controlar o Estoque de forma simples e automática.               | Evitar rupturas de estoque e desperdícios, assegurando que sempre tenha os produtos certos disponíveis para os meus clientes, sem comprometer o meu orçamento. |
| Pedro  Martins    | Um sistema de gerenciamento de Estoque que me permita categorizar os produtos de forma fácil e intuitiva.               | Organizar o Estoque de maneira eficiente, facilitando a localização e controle dos produtos por categoria, o que melhora a gestão e evita erros no estoque. |
...
| Ana    Sousa    | Um sistema de gerenciamento de Estoque que me permita gerar relatórios dos itens cadastrados.      | Analisar o desempenho do Estoque, identificar tendências e tomar decisões informadas para melhorar a gestão de estoque e otimizar recursos.          |
| Luís   Ferreira    | Um sistema de gerenciamento de Estoque que me permita gerenciar e acompanhar meus fornecedores de forma centralizada.  | Manter um controle eficiente sobre os fornecedores, facilitando a negociação, o acompanhamento de entregas e a reposição de estoque, garantindo que sempre haja produtos disponíveis quando necessário.   |
...
| Marta  Oliveira    | Quero uma solução que integre e sincronize o Estoque entre o armazém físico e a loja online.           | Garantir que o estoque esteja sempre atualizado, evitando a venda de produtos fora de estoque e melhorando a satisfação dos clientes. |
| Marta  Oliveira    | Um sistema de gerenciamento de Estoque que me permita pesquisar produtos usando filtros como nome, categoria ou fornecedor.          | Localizar rapidamente os produtos no Estoque, agilizando o processo de consulta e tomada de decisões, e garantindo uma gestão mais eficiente e precisa dos itens em estoque. |
| Ricardo Almeida    | Preciso de uma ferramenta que me forneça dados precisos e em tempo real do Estoque.                    | Realizar análises detalhadas que suportem decisões estratégicas e melhorem a eficiência operacional da empresa.           |
| Ricardo Almeida    | Cadastrar e configurar as informações da minha empresa no sistema de gerenciamento de Estoque.                    | Garantir que o sistema atenda às necessidades específicas da minha empresa.           |
...
|RF-004| O sistema permitirá o usuário a visualizar seu Estoque em tempo real | MÉDIA |
|RF-005| O sistema permitirá o usuário adicionar itens ao seu Estoque| MÉDIA |
|RF-006| O sistema permitirá o usuário deletar itens do seu Estoque | MÉDIA |
...
|RF-010| O sistema permitirá o usuário pesquisar produtos no Estoque usando filtros como nome, categoria ou fornecedor | BAIXA |
...
|RF-013| O sistema permitirá o usuário exportar dados de Estoque em formatos .TXT | MÉDIA |
...
|RNF-006| O sistema deve garantir que não ocorra duplicação de itens no Estoque. | MÉDIA |
...
|06| O sistema de Estoque deve estar em conformidade com as normas técnicas e regulatórias, como as da ABNT |


## Diagrama de Casos de Uso

O diagrama de caso de uso descreve um sistema de Estoque, onde o **Funcionário** interage com várias funcionalidades do sistema. Aqui estão as principais funcionalidades e suas interações:
...
3. **Gerenciar Produtos**: Permite a gestão completa dos produtos, incluindo:
   - **Adicionar Produto**: Adicionar novos produtos ao Estoque.
   - **Editar Produto**: Atualizar informações dos produtos existentes.
   - **Excluir Produto**: Remover produtos do Estoque.
   - **Visualizar Estoque**: Acesso à visualização detalhada do Estoque.
   - **Gerar Relatório**: Criar relatórios baseados nos dados do Estoque.
...
5. **Filtrar Produto**: Permite a filtragem de produtos no Estoque com base em critérios específicos.
...
Cada uma dessas funcionalidades está interligada, e algumas delas incluem ou estendem outras operações, permitindo uma gestão completa e personalizada do Estoque e dos fornecedores associados.

![sistema de Estoque](https://github.com/user-attachments/assets/68e5b06e-39f4-4c31-b904-3f58b9a2c38d)
